...
import argparse
from core.StealthWebDNS.StealthWebDNS import *
from core.StealthWebFingerprint.StealthWebFingerprint import *
from core.StealthWebDir.StealthWebDirectory import *
from core.StealthWebFuzz.StealthWebFuzz import *
from core.StealthWebFile.StealthWebFile import *
from core.StealthWebHelp.StealthWebHelp import *
from core.StealthWebVHost.StealthWebVHost import *

parser = argparse.ArgumentParser(add_help=False)
parser.add_argument('-u','--url',help='Set target URL on Dir enumeration attack')
parser.add_argument('-a','--user-agent',default='StealthWeb v1.0',help='Set user-agent')
