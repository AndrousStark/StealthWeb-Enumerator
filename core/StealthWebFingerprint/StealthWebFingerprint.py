...
class FINGERPRINT_MODULE:
	...
	def main(args):
		...
		if not FINGERPRINT_OPTIONS.TARGET_URL:
			...
			print(f"{TerminalColor.Orange}example 'python3 StealthWeb.py fingerprint -u https://www.domain.com'{TerminalColor.Reset}")
			print(f"{TerminalColor.Orange}Type 'python3 StealthWeb.py fingerprint -h' for commands{TerminalColor.Reset}")
			sys.exit()
		else:
...
<html>
	...
	<body>
		<div class="container">
			<h1 class="text-center">StealthWeb v1.0 - Fingerprint module</h1>
...
Usage:
  python3 StealthWeb.py fingerprint [args]
...
Examples:
	...
	txt output
	use: python3 StealthWeb.py fingerprint -u https://www.domain.com -o report.txt

	html output
	use: python3 StealthWeb.py fingerprint -u https://www.domain.com -o report.html
