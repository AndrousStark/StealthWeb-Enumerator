...
class FILE_MODULE:
	...
	def main(args):
		...
		if not FILE_OPTION.TARGET_URL or not FILE_OPTION.EXTENSIONS:
			...
			print(f"{TerminalColor.Orange}example 'python3 StealthWeb.py file -u https://www.domain.com -x txt,php'{TerminalColor.Reset}")
			print(f"{TerminalColor.Orange}Type 'python3 StealthWeb.py file -h' for commands{TerminalColor.Reset}")
			sys.exit()
		else:
...
<html>
	...
	<body>
		<div class="container">
			<h1 class="text-center">StealthWeb v1.0 - File enumeration module</h1>
...
Usage:
  python3 StealthWeb.py file [args]
...
Examples:
	...
	file enumeration
	use: python3 StealthWeb.py file -u https://www.domain.com/ -w wordlist.txt -x txt,php

	txt output
	use: python3 StealthWeb.py file -u https://www.domain.com/ -w wordlist.txt -x txt,php -o report.txt

	html output
	use: python3 StealthWeb.py file -u https://www.domain.com/ -w wordlist.txt -x txt,php -o report.html
