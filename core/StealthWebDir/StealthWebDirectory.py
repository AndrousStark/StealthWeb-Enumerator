...
class DIRECTORY_MODULE:
	...
	def main(args):
		...
		if not DIRECTORY_OPTION.TARGET_URL:
			...
			print(f"{TerminalColor.Orange}example 'python3 StealthWeb.py dir -u https://www.domain.com'{TerminalColor.Reset}")
			print(f"{TerminalColor.Orange}Type 'python3 StealthWeb.py dir -h' for commands{TerminalColor.Reset}")
			sys.exit()
		else:
...
<html>
	...
	<body>
		<div class="container">
			<h1 class="text-center">StealthWeb v1.0 - Directories enumeration module</h1>
...
Examples:
	...
	txt output
	use: python3 StealthWeb.py dir -u https://www.domain.com/ -w wordlist.txt -o report.txt

	html output
	use: python3 StealthWeb.py dir -u https://www.domain.com/ -w wordlist.txt -o report.html
