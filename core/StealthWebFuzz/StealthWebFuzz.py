from core.StealthWeb.main import *
import validators
import sys
import requests
...
class FUZZ_MODULE:
	def main(args):
		...
		if not FUZZ_OPTION.TARGET_URL:
			...
			print(f"{TerminalColor.Orange}example 'python3 StealthWeb.py fuzz -u https://www.domain.com/FUZZ'{TerminalColor.Reset}")
			print(f"{TerminalColor.Orange}Type 'python3 StealthWeb.py fuzz -h' for commands{TerminalColor.Reset}")
			sys.exit()
		else:
			...
			if not "FUZZ" in FUZZ_OPTION.TARGET_URL:
				...
				print(f"{TerminalColor.Orange}example 'python3 StealthWeb.py fuzz -u https://www.domain.com/FUZZ'{TerminalColor.Reset}")
				print(f"{TerminalColor.Orange}Type 'python3 StealthWeb.py help' for commands{TerminalColor.Reset}")
				sys.exit()
...
<html>
	...
	<body>
		<div class="container">
			<h1 class="text-center">StealthWeb v1.0 - Fuzz enumeration module</h1>
...
Usage:
  python3 StealthWeb.py dir [args]
...
Examples:
	...
	use: python3 StealthWeb.py fuzz -u https://www.domain.com/FUZZ -w wordlist.txt -s 200,301

	txt output
	use: python3 StealthWeb.py fuzz -u https://www.domain.com/FUZZ -w wordlist.txt -o report.txt

	html output
	use: python3 StealthWeb.py fuzz -u https://www.domain.com/FUZZ -w wordlist.txt -o report.html
